...
public class AdminHandler {
    ...
    public ResultEntity<String> removeByRoleIdArray(@RequestBody List<Integer> adminIdList) {

        adminService.removeList(adminIdList);
    ...
    @PreAuthorize("hasAuthority('user:save')")// 设置权限授权
